...
server.listen(PORT, () => {
    console.log(`✅ Community Report System Backend is running on http://localhost:${PORT}`);
    console.log(`📁 Data stored in: ${reportsFile}`);
    console.log(`\n🎯 Available endpoints:`);
    ...
    console.log(`\n🌐 Open client at: file://${path.join(__dirname, 'client-example.html').replace(/\\/g, '/')}`);
});